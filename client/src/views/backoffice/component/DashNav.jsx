            ...
            <nav className="dash-nav-container">
                <div className='dash-nav-links'>
                    <button className='dash-nav-link' onClick={handleLogout}>
                        <a href='/'><h4>Se déconnecter</h4></a>
                        <svg width="50" height="50" viewBox="0 0 87 67" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <button className='dash-nav-link'>
                        <a href={path}><h4>Vers {text}</h4></a>
                        <svg width="50" height="50" viewBox="0 0 456 319" fill="none" xmlns="http://www.w3.org/2000/svg">
