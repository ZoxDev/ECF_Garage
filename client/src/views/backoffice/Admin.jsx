            ...
            <>
                ...
                <OpenModal showmodal={isOpen}>
                    <div className='modal-update'>
                        <button onClick={onClickBtn}>FERMER</button>
                        <form>
                            <input value={title} onChange={(e) => setTitle(e.target.value)} type="text" placeholder='Titre' />
        ...
        <>
            <section className="admin-container">
                ...
                <div className="admin-menu">
                    <h2>Panel</h2>
                    <button className="btn-admin">Informations</button>
                    <button className="btn-admin">Horraires</button>
                    <button className="btn-admin">Employées</button>
                    <button className="btn-admin">Avis</button>
